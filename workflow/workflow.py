...
class Workflow(object):
    ...
    def send_feedback(self):
        ...
        self.add_item("marc","marc","","marc","marc",True,"1234","","","","",",")
        sorted_items = sorted(self._items, key=lambda x: x.title.lower())

        self.logger.debug("!!!my debugger!!!")

        # Debugging: Print or log the sorted items
        print("Sending feedback, sorted items:")
        for item in sorted_items:
            print(f"Title: {item.title}")

        xml_string = ET.tostring(root, encoding="unicode")
        with open("/Users/marcotten/Documents/projects/alfred-cheat/test.xml", "w", encoding="utf-8") as f:
